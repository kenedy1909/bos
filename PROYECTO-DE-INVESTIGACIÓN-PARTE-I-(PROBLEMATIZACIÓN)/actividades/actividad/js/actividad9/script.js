...
function init_recurso_1() {
    ...
    var Ahorcado = function () {
        ...
        this.palabrasMake = function () {
            ...
            this.palabras[0] = ['tutela', ''];
            this.palabras[1] = ['tutela', ''];
            this.palabras[2] = ['tutela', ''];
            this.palabras[4] = ['tutela', ''];
            this.palabras[5] = ['tutela', ''];
            this.palabras[6] = ['tutela', ''];
            this.palabras[7] = ['tutela', ''];
            this.palabras[8] = ['tutela', ''];
