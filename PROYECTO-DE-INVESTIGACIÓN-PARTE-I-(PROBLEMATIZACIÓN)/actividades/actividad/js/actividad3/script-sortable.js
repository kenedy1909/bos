...
var arrOrigenR1 = [
    {
        ...
        '<div class="opcion_circulo_content"><div class="opcion_circulo_text"><img src="../img/img3/justificar3.png" style="max-whidth: 20%;"></div></div>\n'+
        '</div>\n'
    },
    {
        code : '<div class="componente opcion_circulo" data-order-origen="contenedorB" >\n'+
        '<div class="opcion_circulo_content"><div class="opcion_circulo_text"><img src="../img/img3/problema.png" style="max-whidth: 20%;"></div></div>\n'+
        '</div>\n'
    },
    {
        code : '<div class="componente opcion_circulo" data-order-origen="contenedorC" >\n'+
        '<div class="opcion_circulo_content"><div class="opcion_circulo_text"><img src="../img/img3/libro.png" style="max-whidth: 20%;"></div></div>\n'+
        '</div>\n'
    },
    {
        code : '<div class="componente opcion_circulo" data-order-origen="contenedorD" >\n'+
        '<div class="opcion_circulo_content"><div class="opcion_circulo_text"><img src="../img/img3/leer.png" style="max-whidth: 20%;"></div></div>\n'+
        '</div>\n'
    }
];
...
function reinitREDIR1() {
    jR1 = 0;
    $(contenedorAR1).html('<h2 class="tituloContenedor tituloContenedorA">¿Es útil ésta investigación?</h2>');
    $(contenedorBR1).html('<h2 class="tituloContenedor tituloContenedorB">¿Para qué y a quién le sirve la investigación?</h2>');
    $(contenedorCR1).html('<h2 class="tituloContenedor tituloContenedorC">Se producirá un nuevo conocimiento</h2>');
