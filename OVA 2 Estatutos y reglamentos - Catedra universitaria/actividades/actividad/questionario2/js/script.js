...
angular.module("leccion3App", []).controller("actividad1Ctrl", function($scope, $log) {
    ...
    var shuffleArray = function(array) {
        ...
        getPreguntas = function() {
            return shuffleArray([{
                texto: "No es un principio básico del código de ética:",
                respuestas: [{
                    texto: "Competencias y aptitudes.",
                    correcta: false
                }, {
                    texto: "Compromiso profesional y teórico.",
                    correcta: false
                }, {
                    texto: "Habilidades técnicas.",
                    correcta: true
                }, {
                    texto: "Integridad y responsabilidad social.",
                    correcta: false
                }]
            }]);
        };
