...
var arrOrigenR1 = [
    {
        code : '<div  data-order-origen="contenedorA">\n'+
                    '<img class="img-50" src="../../../assets/img/img_ova/Crecimiento.png" style="width:70%;">\n'+
                '</div>\n'
    },
    {
        code : '<div  data-order-origen="contenedorB">\n'+
                    '<img class="img-50" src="../../../assets/img/img_ova/Impedimentos.png" style="width:80%;">\n'+
                '</div>\n'
    },
    {
        code : '<div  data-order-origen="contenedorC">\n'+
                    '<img  src="../../../assets/img/img_ova/ODS.png" style="width:50%;">\n'+
                '</div>'
    }
];
...
function reinitREDIR1() {
    jR1 = 0;
    $(contenedorAR1).html('<h2 class="tituloContenedor tituloContenedorA">PIB</h2>');
    $(contenedorBR1).html('<h2 class="tituloContenedor tituloContenedorB">IMPEDIMENTOS</h2>');
    $(contenedorCR1).html('<h2 class="tituloContenedor tituloContenedorC">ODS</h2>');
    inicioREDIR1();
 }
