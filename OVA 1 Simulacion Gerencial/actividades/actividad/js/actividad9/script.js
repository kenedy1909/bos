...
function init_recurso_1() {
    ...
    var Ahorcado = function () {
        ...
        this.palabrasMake = function () {
            ...
            this.palabras[0] = ['Diseño Metodológico', ''];
            this.palabras[1] = ['Diseño Metodológico', ''];
            this.palabras[2] = ['Diseño Metodológico', ''];
            this.palabras[4] = ['Diseño Metodológico', ''];
            this.palabras[5] = ['Diseño Metodológico', ''];
            this.palabras[6] = ['Diseño Metodológico', ''];
            this.palabras[7] = ['Diseño Metodológico', ''];
            this.palabras[8] = ['Diseño Metodológico', ''];
