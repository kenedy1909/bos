$( document ).ready(function() {
    ...
    $(".unidad3-1").on("click", function (argument) {
        $(".punidad3").hide()
        $(".unidad3-p1").show(300)
    })

    $(".unidad3-2").on("click", function (argument) {
        $(".punidad3").hide()
        $(".unidad3-p2").show(300)
    })

    $(".unidad3-3").on("click", function (argument) {
        $(".punidad3").hide()
        $(".unidad3-p3").show(300)
    })

    $(".unidad3-4").on("click", function (argument) {
        $(".punidad3").hide()
        $(".unidad3-p4").show(300)
    })

    $(".unidad3-5").on("click", function (argument) {
        $(".punidad3").hide()
        $(".unidad3-p5").show(300)
    })

    $(".unidad3-6").on("click", function (argument) {
        $(".punidad3").hide()
        $(".unidad3-p6").show(300)
    })

    $(".unidad3-7").on("click", function (argument) {
        $(".punidad3").hide()
        $(".unidad3-p7").show(300)
    })

    $(".unidad3-8").on("click", function (argument) {
        $(".punidad3").hide()
        $(".unidad3-p8").show(300)
    })

    $(".unidad3-9").on("click", function (argument) {
        $(".punidad3").hide()
        $(".unidad3-p9").show(300)
    })


    $(".btn-3-1").on("click", function (argument) {
        $(".parrafo3").hide()
        $(".parrafo-3-1").show(300)
    })
    $(".btn-3-2").on("click", function (argument) {
        $(".parrafo3").hide()
        $(".parrafo-3-2").show(300)
    })
    $(".btn-3-3").on("click", function (argument) {
        $(".parrafo3").hide()
        $(".parrafo-3-3").show(300)
    })
...
function slide_predeterminado(){
    ...
    controlSlides(1);
    window.location.href ="#unidad3-1";
}

function slide_link(num){
    $(".nav-link").removeClass('done');
    $(".nav-link").removeClass('active');
    window.location.href ="#unidad3-"+num;
    controlSlides(num);
}
