...
const palabras = [
  {
    ...
    pista: 'Esta es la fase que más tiempo toma, además es la más costosa para la organización, incluso más costosa que el mismo diseño y desarrollo.'
  },
  {
    pos: [13, 0],
    sentido: 1,
    palabra: 'pruebas',
    pista: 'Se sugiere que las ________ de un sistema se realicen por partes, y que involucren a la mayor cantidad posible de usuarios, luego se puede hacer una prueba de funcionamiento del sistema como un todo.'
  },
  {
    pos: [8, 1],
    sentido: 0,
    palabra: 'desarrollo',
    pista: 'El _________ de un sistema consiste en la traducción del diseño de dicho sistema a una forma entendible para la computadora.'
  },
  {
    pos: [3, 2],
    sentido: 1,
    palabra: 'analisis',
    pista: 'En esta fase se analiza la viabilidad o factibilidad del sistema, además, se definen los requerimientos técnicos para el desarrollo'
  },
  {
    pos: [0, 5],
    sentido: 0,
    palabra: 'implantacion',
    pista: 'Una vez se ha definido que el producto está terminado, probado y para entrega, se procede con la fase de…'
  },
  {
    pos: [8, 10],
    sentido: 0,
    palabra: 'planeacion',
    pista: 'Es la etapa más determinante desde la perspectiva gerencial en el diseño de un sistema de información puesto que en ella se identifica la problemática que tiene la organización.'
  }
]
