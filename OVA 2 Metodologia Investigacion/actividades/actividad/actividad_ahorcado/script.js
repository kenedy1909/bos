...
function init_recurso_1() {
    ...
    var Ahorcado = function () {
        ...
        this.palabrasMake = function () {
            ...
            this.palabras[0] = ['revision-de-la-literatura', 'El marco teórico es llamado de esta manera.'];
            this.palabras[1] = ['revision-de-la-literatura', 'El marco teórico es llamado de esta manera.'];
            this.palabras[2] = ['revision-de-la-literatura', 'El marco teórico es llamado de esta manera.'];
            this.palabras[4] = ['revision-de-la-literatura', 'El marco teórico es llamado de esta manera.'];
            this.palabras[5] = ['revision-de-la-literatura', 'El marco teórico es llamado de esta manera.'];
            this.palabras[6] = ['revision-de-la-literatura', 'El marco teórico es llamado de esta manera.'];
            this.palabras[7] = ['revision-de-la-literatura', 'El marco teórico es llamado de esta manera.'];
            this.palabras[8] = ['revision-de-la-literatura', 'El marco teórico es llamado de esta manera.'];
    ...
    Ahorcado.prototype.dibujarPoste = function () {
        ...
        this.canvas_ahorcado.canvasArea.strokeStyle = "#9f4c97";
