...
function init_recurso_1() {
    ...
    var Ahorcado = function () {
        ...
        this.palabrasMake = function () {
            ...
            this.palabras[0] = ['cualitativo', 'En este tipo de investigación o método se hace uso de los criterios de credibilidad, transferibilidad y conformidad, como factores de credibilidad y confianza para los hallazgos del estudio en cuestión.'];
            this.palabras[1] = ['cualitativo', 'En este tipo de investigación o método se hace uso de los criterios de credibilidad, transferibilidad y conformidad, como factores de credibilidad y confianza para los hallazgos del estudio en cuestión.'];
            this.palabras[2] = ['cualitativo', 'En este tipo de investigación o método se hace uso de los criterios de credibilidad, transferibilidad y conformidad, como factores de credibilidad y confianza para los hallazgos del estudio en cuestión.'];
            this.palabras[3] = ['cualitativo', 'En este tipo de investigación o método se hace uso de los criterios de credibilidad, transferibilidad y conformidad, como factores de credibilidad y confianza para los hallazgos del estudio en cuestión.'];
            this.palabras[4] = ['cualitativo', 'En este tipo de investigación o método se hace uso de los criterios de credibilidad, transferibilidad y conformidad, como factores de credibilidad y confianza para los hallazgos del estudio en cuestión.'];
            this.palabras[5] = ['cualitativo', 'En este tipo de investigación o método se hace uso de los criterios de credibilidad, transferibilidad y conformidad, como factores de credibilidad y confianza para los hallazgos del estudio en cuestión.'];
            this.palabras[6] = ['cualitativo', 'En este tipo de investigación o método se hace uso de los criterios de credibilidad, transferibilidad y conformidad, como factores de credibilidad y confianza para los hallazgos del estudio en cuestión.'];
            this.palabras[7] = ['cualitativo', 'En este tipo de investigación o método se hace uso de los criterios de credibilidad, transferibilidad y conformidad, como factores de credibilidad y confianza para los hallazgos del estudio en cuestión.'];
            this.palabras[8] = ['cualitativo', 'En este tipo de investigación o método se hace uso de los criterios de credibilidad, transferibilidad y conformidad, como factores de credibilidad y confianza para los hallazgos del estudio en cuestión.'];
    ...
    Ahorcado.prototype.dibujarPoste = function () {
        ...
        this.canvas_ahorcado.canvasArea.strokeStyle = "#771e18";
