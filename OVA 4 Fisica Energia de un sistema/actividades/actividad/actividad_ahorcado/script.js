...
function init_recurso_1() {
    ...
    var Ahorcado = function () {
        ...
        this.palabrasMake = function () {
            ...
            this.palabras[0] = ['trabajo', 'Complete la palabra'];
            this.palabras[1] = ['trabajo', 'Complete la palabra'];
            this.palabras[2] = ['trabajo', 'Complete la palabra'];
            this.palabras[3] = ['trabajo', 'Complete la palabra'];
            this.palabras[4] = ['trabajo', 'Complete la palabra'];
            this.palabras[5] = ['trabajo', 'Complete la palabra'];
            this.palabras[6] = ['trabajo', 'Complete la palabra'];
            this.palabras[7] = ['trabajo', 'Complete la palabra'];
    ...
    Ahorcado.prototype.dibujarPoste = function () {
        ...
        this.canvas_ahorcado.canvasArea.strokeStyle = "#006092";
