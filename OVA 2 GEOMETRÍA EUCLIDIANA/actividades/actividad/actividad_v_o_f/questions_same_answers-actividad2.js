...
var TEMPLATE = '<form id="{{ id }}" method="post" class="qwsa-form">\
      ...
      <div class="border_punteado">\
        <table class="table tabla-actividad2 ">\
            <thead>\
                ...
                {% endif %}\
                <tr>\
                    <th>Dado el conjunto referencial  <img src="../img/img1/Imagen6.png"> <br> Determine si es verdadera a falsa la afirmación: </th>\
    ...
    <div class="text-center">\
        <button class="btn shadow" style="background: #003442; color: #fff; border-radius: 12px;" type="submit" ><h4><b>Calificar</b></h4></button>\
    </div>\
</form>'
