...
function reinitREDIR1() {
    jR1 = 0;
    $(contenedorAR1).html('<h2 class="tituloContenedor tituloContenedorA">ESTRATEGIA 1</h2>');
    $(contenedorBR1).html('<h2 class="tituloContenedor tituloContenedorB">ESTRATEGIA 2</h2>');
    $(contenedorCR1).html('<h2 class="tituloContenedor tituloContenedorC">ESTRATEGIA 3</h2>');
    $(contenedorDR1).html('<h2 class="tituloContenedor tituloContenedorD">ESTRATEGIA 4</h2>');
    inicioREDIR1();
 }
