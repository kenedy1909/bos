...
angular.module("leccion3App", []).controller("actividad1Ctrl", function($scope, $log) {
    ...
    var shuffleArray = function(array) {
        ...
        getPreguntas = function() {
            return shuffleArray([{
                texto: "En caso de que intervengan 3 variables proposicionales, ¿cuántas posibles combinaciones existen para los valores de verdad de estas? (Seleccionar la respuesta correcta).",
                respuestas: [{
                    texto: "6",
                    correcta: false
                }, {
                ...
                texto: "En caso de que intervengan 4 variables proposicionales, ¿cuántas posibles combinaciones existen para los valores de verdad de estas?",
                respuestas: [{
                    texto: "8",
                    correcta: false
                }, {
