...
var arrOrigenR1 = [
    {
        ...
        '<div style="text-align: center;position: relative;top: -50px;height: 20px;"><img src="img/reflexion.png" style="max-width: 40%;"></div>\n'+
    ...
    },
    {
        ...
        '<div style="width: 99%;background: #F7E448;padding: 25px;border-radius: 30px;box-shadow: 1px 1px 7px 0px;" >\n'+
        '<div style="text-align: center;position: relative;top: -50px;height: 20px;"><img src="img/dato.png" style="max-width: 40%;"></div>\n'+
    ...
    },
    {
        ...
        '<div style="width: 99%;background: #F7E448;padding: 25px;border-radius: 30px;box-shadow: 1px 1px 7px 0px;" >\n'+
        '<div style="text-align: center;position: relative;top: -50px;height: 20px;"><img src="img/verificacion_antecedentes.png" style="max-width: 40%;"></div>\n'+
