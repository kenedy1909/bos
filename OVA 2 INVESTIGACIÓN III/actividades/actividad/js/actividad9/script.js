...
function init_recurso_1() {
    ...
    var Ahorcado = function () {
        ...
        this.palabrasMake = function () {
            ...
            this.palabras[0] = ['diseño-metodologico', ''];
            this.palabras[1] = ['diseño-metodologico', ''];
            this.palabras[2] = ['diseño-metodologico', ''];
            this.palabras[4] = ['diseño-metodologico', ''];
            this.palabras[5] = ['diseño-metodologico', ''];
            this.palabras[6] = ['diseño-metodologico', ''];
            this.palabras[7] = ['diseño-metodologico', ''];
            this.palabras[8] = ['diseño-metodologico', ''];
