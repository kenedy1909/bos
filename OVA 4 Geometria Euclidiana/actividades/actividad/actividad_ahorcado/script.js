...
function init_recurso_1() {
    ...
    var Ahorcado = function () {
        ...
        this.palabrasMake = function () {
            ...
            this.palabras[0] = ['angulo', 'Complete la frase “ Suplemento de un...”'];
            this.palabras[1] = ['angulo', 'Complete la frase “ Suplemento de un...”'];
            this.palabras[2] = ['angulo', 'Complete la frase “ Suplemento de un...”'];
            this.palabras[3] = ['angulo', 'Complete la frase “ Suplemento de un...”'];
            this.palabras[4] = ['angulo', 'Complete la frase “ Suplemento de un...”'];
            this.palabras[5] = ['angulo', 'Complete la frase “ Suplemento de un...”'];
            this.palabras[6] = ['angulo', 'Complete la frase “ Suplemento de un...”'];
            this.palabras[7] = ['angulo', 'Complete la frase “ Suplemento de un...”'];
            this.palabras[8] = ['angulo', 'Complete la frase “ Suplemento de un...”'];
    ...
    Ahorcado.prototype.dibujarPoste = function () {
        ...
        this.canvas_ahorcado.canvasArea.strokeStyle = "#FFC000";
