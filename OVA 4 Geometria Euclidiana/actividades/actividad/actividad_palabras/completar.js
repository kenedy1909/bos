...
function calificar(){
	...
	if (puntaje == 100) {
	  ...
	  $('.btns_modal').html('<button type="button" class="btn" data-dismiss="modal" style="font-size: 20px;color: #006092;font-weight: bold;margin-top: -15px;">cerrar</button>');
	  ...
	  $('.puntaje').text(Math.round(puntaje)+"%");
	  $('.btns_modal').html('<button style="font-size: 20px;color: #006092;font-weight: bold;margin-top: -15px;" id="add" class="btn" onclick="reiniciar();">Volver a intentar</button>');
	}
}
