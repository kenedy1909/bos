...
function init_recurso_1() {
    ...
    var Ahorcado = function () {
        ...
        this.palabrasMake = function () {
            ...
            this.palabras[0] = ['los-datos', 'Es una representación simbólica o atributo de un hecho, acontecimiento, o suceso , que puede ser representado de manera cuantitativa o cualitativa.'];
            this.palabras[1] = ['los-datos', 'Es una representación simbólica o atributo de un hecho, acontecimiento, o suceso , que puede ser representado de manera cuantitativa o cualitativa.'];
            this.palabras[2] = ['los-datos', 'Es una representación simbólica o atributo de un hecho, acontecimiento, o suceso , que puede ser representado de manera cuantitativa o cualitativa.'];
            this.palabras[3] = ['los-datos', 'Es una representación simbólica o atributo de un hecho, acontecimiento, o suceso , que puede ser representado de manera cuantitativa o cualitativa.'];
            this.palabras[4] = ['los-datos', 'Es una representación simbólica o atributo de un hecho, acontecimiento, o suceso , que puede ser representado de manera cuantitativa o cualitativa.'];
            this.palabras[5] = ['los-datos', 'Es una representación simbólica o atributo de un hecho, acontecimiento, o suceso , que puede ser representado de manera cuantitativa o cualitativa.'];
            this.palabras[6] = ['los-datos', 'Es una representación simbólica o atributo de un hecho, acontecimiento, o suceso , que puede ser representado de manera cuantitativa o cualitativa.'];
            this.palabras[7] = ['los-datos', 'Es una representación simbólica o atributo de un hecho, acontecimiento, o suceso , que puede ser representado de manera cuantitativa o cualitativa.'];
            this.palabras[8] = ['los-datos', 'Es una representación simbólica o atributo de un hecho, acontecimiento, o suceso , que puede ser representado de manera cuantitativa o cualitativa.'];
