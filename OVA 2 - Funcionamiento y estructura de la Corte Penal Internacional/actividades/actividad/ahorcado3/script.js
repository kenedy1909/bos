...
function init_recurso_1() {
    ...
    var Ahorcado = function () {
        ...
        this.palabrasMake = function () {
            ...
            this.palabras[0] = ['estatutoderoma', 'Puede considerarse como una de las fuentes del Derecho Penal Internacional'];
            this.palabras[1] = ['estatutoderoma', 'Puede considerarse como una de las fuentes del Derecho Penal Internacional'];
            this.palabras[2] = ['estatutoderoma', 'Puede considerarse como una de las fuentes del Derecho Penal Internacional'];
            this.palabras[4] = ['estatutoderoma', 'Puede considerarse como una de las fuentes del Derecho Penal Internacional'];
            this.palabras[5] = ['estatutoderoma', 'Puede considerarse como una de las fuentes del Derecho Penal Internacional'];
            this.palabras[6] = ['estatutoderoma', 'Puede considerarse como una de las fuentes del Derecho Penal Internacional'];
            this.palabras[7] = ['estatutoderoma', 'Puede considerarse como una de las fuentes del Derecho Penal Internacional'];
            this.palabras[8] = ['estatutoderoma', 'Puede considerarse como una de las fuentes del Derecho Penal Internacional'];
