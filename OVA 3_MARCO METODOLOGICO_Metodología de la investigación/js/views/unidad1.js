...
function cardPara4(num, ventana) {
    ...
    if (ventana == 1) {
        ...
        if (num == 2) {
            var conjunto = `
          <div class="col-6 bg-color-1 text-center border-1" id="card4-1" onclick="cardPara4(1,1)"> <img src="assets/img/img_ova/pregunta.png" class="w-50 p-3 cursor" id="img-card4-1"></div>
