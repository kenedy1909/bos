...
function init_recurso_1() {
    ...
    var Ahorcado = function () {
        ...
        this.palabrasMake = function () {
            ...
            this.palabras[0] = ['indigena', 'Persona originaria del país de que se trata.'];
            this.palabras[1] = ['indigena', 'Persona originaria del país de que se trata.'];
            this.palabras[2] = ['indigena', 'Persona originaria del país de que se trata.'];
            this.palabras[3] = ['indigena', 'Persona originaria del país de que se trata.'];
            this.palabras[4] = ['indigena', 'Persona originaria del país de que se trata.'];
            this.palabras[5] = ['indigena', 'Persona originaria del país de que se trata.'];
            this.palabras[6] = ['indigena', 'Persona originaria del país de que se trata.'];
            this.palabras[7] = ['indigena', 'Persona originaria del país de que se trata.'];
            this.palabras[8] = ['indigena', 'Persona originaria del país de que se trata.'];
    ...
    Ahorcado.prototype.dibujarPoste = function () {
        ...
        this.canvas_ahorcado.canvasArea.strokeStyle = "#008F3E";
        ...
        if (!flag) {
            ...
            if (this.gano()) {
               ...
               /* mostrarCalificacion(modalID, '100%', mensaje, exito, function () {
                ...
                $('.img_res').html('<img src="../img/img7/bien.png" style="max-width: 90%; margin-top: 6%;">');
                $('.puntaje').text("100%");
