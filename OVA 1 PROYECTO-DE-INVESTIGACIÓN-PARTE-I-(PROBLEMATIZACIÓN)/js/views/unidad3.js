      ...
      <div class="flip-card-inner4" style="border-radius: 50px;">
        ...
        <div class="flip-card-back4 shadow p-4">
          <div class="content borderDsh">
              ...
              <p class="text-peq1 font_14 justificado font-weight-bold p-2 mt-4">Argumentos que muestren la importancia para la disciplina jurídica, es decir, se debe mostrar, que para una ciencia como el derecho esa investigación ofrece múltiples posibilidades, que puede solucionar muchos problemas jurídicos y que la disciplina se enriquecería teórica o prácticamente si se lleva a cabo. 
              </p>
      ...
      <div class="flip-card-inner4" style="border-radius: 50px;">
        ...
        <div class="flip-card-back4 shadow p-4">
          <div class="content borderDsh">
              ...
              <p class="text-peq1 font_14 justificado font-weight-bold p-2 mt-4">Argumentos que muestren qué le ofrecería esta investigación al equipo investigador: es decir, en qué los enriquecería a ellos, cómo el equipo puede crecer y en qué sentidos, si se lleva a cabo. Es arriesgarse a involucrarse, a sentir que lo hecho transforma la propia vida y que la investigación es una forma de vida. 
              </p>
