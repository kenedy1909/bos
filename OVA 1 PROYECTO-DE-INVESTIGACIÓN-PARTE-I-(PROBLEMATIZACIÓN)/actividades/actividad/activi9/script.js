...
function init_recurso_1() {
    ...
    var Ahorcado = function () {
        ...
        this.palabrasMake = function () {
            ...
            this.palabras[0] = ['tutela', 'Mecanismo para restituir los derechos de los seres humanos'];
            this.palabras[1] = ['tutela', 'Mecanismo para restituir los derechos de los seres humanos'];
            this.palabras[2] = ['tutela', 'Mecanismo para restituir los derechos de los seres humanos'];
            this.palabras[3] = ['tutela', 'Mecanismo para restituir los derechos de los seres humanos'];
            this.palabras[4] = ['tutela', 'Mecanismo para restituir los derechos de los seres humanos'];
            this.palabras[5] = ['tutela', 'Mecanismo para restituir los derechos de los seres humanos'];
            this.palabras[6] = ['tutela', 'Mecanismo para restituir los derechos de los seres humanos'];
            this.palabras[7] = ['tutela', 'Mecanismo para restituir los derechos de los seres humanos'];
            this.palabras[8] = ['tutela', 'Mecanismo para restituir los derechos de los seres humanos'];
