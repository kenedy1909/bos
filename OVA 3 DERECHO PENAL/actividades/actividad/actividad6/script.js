...
function init_recurso_1() {
    ...
    var Ahorcado = function () {
        ...
        this.palabrasMake = function () {
            ...
            this.palabras[0] = ['autoriamaterial', 'Cuando la persona realiza por sí misma la conducta constitutiva de crimen internacional'];
            this.palabras[1] = ['autoriamaterial', 'Cuando la persona realiza por sí misma la conducta constitutiva de crimen internacional'];
            this.palabras[2] = ['autoriamaterial', 'Cuando la persona realiza por sí misma la conducta constitutiva de crimen internacional'];
            this.palabras[3] = ['autoriamaterial', 'Cuando la persona realiza por sí misma la conducta constitutiva de crimen internacional'];
            this.palabras[4] = ['autoriamaterial', 'Cuando la persona realiza por sí misma la conducta constitutiva de crimen internacional'];
            this.palabras[5] = ['autoriamaterial', 'Cuando la persona realiza por sí misma la conducta constitutiva de crimen internacional'];
            this.palabras[6] = ['autoriamaterial', 'Cuando la persona realiza por sí misma la conducta constitutiva de crimen internacional'];
            this.palabras[7] = ['autoriamaterial', 'Cuando la persona realiza por sí misma la conducta constitutiva de crimen internacional'];
            this.palabras[8] = ['autoriamaterial', 'Cuando la persona realiza por sí misma la conducta constitutiva de crimen internacional'];
