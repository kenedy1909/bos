...
function init_recurso_1() {
    ...
    var Ahorcado = function() {
        ...
        this.palabrasMake = function() {
            ...
            this.palabras[0] = ['modeloagregador', 'Es cuando el dinero recaudado por parte de la venta llega a la cuenta bancaria de la pasarela y esta posteriormente lo transfiere a la cuenta del E-commerce. '];
            this.palabras[1] = ['modeloagregador', 'Es cuando el dinero recaudado por parte de la venta llega a la cuenta bancaria de la pasarela y esta posteriormente lo transfiere a la cuenta del E-commerce. '];
            this.palabras[2] = ['modeloagregador', 'Es cuando el dinero recaudado por parte de la venta llega a la cuenta bancaria de la pasarela y esta posteriormente lo transfiere a la cuenta del E-commerce. '];
            this.palabras[3] = ['modeloagregador', 'Es cuando el dinero recaudado por parte de la venta llega a la cuenta bancaria de la pasarela y esta posteriormente lo transfiere a la cuenta del E-commerce. '];
            this.palabras[4] = ['modeloagregador', 'Es cuando el dinero recaudado por parte de la venta llega a la cuenta bancaria de la pasarela y esta posteriormente lo transfiere a la cuenta del E-commerce. '];
            this.palabras[5] = ['modeloagregador', 'Es cuando el dinero recaudado por parte de la venta llega a la cuenta bancaria de la pasarela y esta posteriormente lo transfiere a la cuenta del E-commerce. '];
            this.palabras[6] = ['modeloagregador', 'Es cuando el dinero recaudado por parte de la venta llega a la cuenta bancaria de la pasarela y esta posteriormente lo transfiere a la cuenta del E-commerce. '];
            this.palabras[7] = ['modeloagregador', 'Es cuando el dinero recaudado por parte de la venta llega a la cuenta bancaria de la pasarela y esta posteriormente lo transfiere a la cuenta del E-commerce. '];
            this.palabras[8] = ['modeloagregador', 'Es cuando el dinero recaudado por parte de la venta llega a la cuenta bancaria de la pasarela y esta posteriormente lo transfiere a la cuenta del E-commerce. '];
    ...
    Ahorcado.prototype.dibujarPoste = function() {
        ...
        this.canvas_ahorcado.canvasArea.strokeStyle = "#811111";
    ...
    Ahorcado.prototype.jugar = function(datos, btn) {
        ...
        if (!flag) {
            ...
            if (!ahorcado.vivo) {
                ...
                $('.img_res').html('<img src="img1/mal.png" style="max-width: 80%;margin-top: 10%;margin-left: 1px;">');
            ...
            if (this.gano()) {
                ...
                $('.img_res').html('<img src="img1/bien.png" style="max-width: 80%; margin-top: 10%;margin-left: 1px;">');
                $('.puntaje').text("100%");
