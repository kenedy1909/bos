...
function init_recurso_1() {
    ...
    var Ahorcado = function () {
        ...
        this.palabrasMake = function () {
            ...
            this.palabras[0] = ['sistema-cegesimal', ''];
            this.palabras[1] = ['sistema-cegesimal', ''];
            this.palabras[2] = ['sistema-cegesimal', ''];
            this.palabras[3] = ['sistema-cegesimal', ''];
            this.palabras[4] = ['sistema-cegesimal', ''];
            this.palabras[5] = ['sistema-cegesimal', ''];
            this.palabras[6] = ['sistema-cegesimal', ''];
            this.palabras[7] = ['sistema-cegesimal', ''];
            this.palabras[8] = ['sistema-cegesimal', ''];
