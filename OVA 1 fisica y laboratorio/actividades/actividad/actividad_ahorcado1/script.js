...
function init_recurso_1() {
    ...
    var Ahorcado = function () {
        ...
        this.palabrasMake = function () {
            ...
            this.palabras[0] = ['imperial', ''];
            this.palabras[1] = ['imperial', ''];
            this.palabras[2] = ['imperial', ''];
            this.palabras[3] = ['imperial', ''];
            this.palabras[4] = ['imperial', ''];
            this.palabras[5] = ['imperial', ''];
            this.palabras[6] = ['imperial', ''];
            this.palabras[7] = ['imperial', ''];
            this.palabras[8] = ['imperial', ''];
