...
function calificar(){
  ...
  if (puntaje == 100) {
    $('.img_res').html('<img src="../img/img11/bien.png" style="max-width: 90%;top: 7px; left: 1px;position: relative;">');
    ...
    $('.img_res').html('<div class="circulo-naranja"> <img src="../img/img11/mal.png" style="max-width: 90%;"></div>');
