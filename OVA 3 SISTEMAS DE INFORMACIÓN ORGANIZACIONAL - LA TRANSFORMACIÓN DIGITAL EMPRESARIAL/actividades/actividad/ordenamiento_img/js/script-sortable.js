...
function reinitREDIR1() {
    jR1 = 0;
    $(contenedorAR1).html('<h2 class="tituloContenedor tituloContenedorA">Conceptos de megatendencias</h2>');
    $(contenedorBR1).html('<h2 class="tituloContenedor tituloContenedorB">¿Qué son las megatendencias?</h2>');
    $(contenedorCR1).html('<h2 class="tituloContenedor tituloContenedorC">Definición de las tendencias</h2>');
    $(contenedorDR1).html('<h2 class="tituloContenedor tituloContenedorD">Temática de megatendencias</h2>');
    inicioREDIR1();
 }
