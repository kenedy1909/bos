       ...
       /* var modalID = "#calificacionModal";
        ...
        if (!flag) {
            ...
            if (!ahorcado.vivo) {
                ...
                $('.btns_modal').html('<button style="font-size: 20px;color: #420F0F;font-weight: bold;margin-top: 25px;" id="add" class="btn calificacion-intentar" data-dismiss="modal" onclick="reload()">Volver a intentar</button>');
            ...
            if (this.gano()) {
                ...
                $('.btns_modal').html('<button type="button" class="btn" data-dismiss="modal" style="font-size: 20px;color: #420F0F;font-weight: bold;margin-top: 25px;" onclick="reload()">cerrar</button>');
