...
function init_recurso_1() {
    ...
    var Ahorcado = function() {
        ...
        this.palabrasMake = function() {
            ...
            this.palabras[0] = ['moral', 'Se concibe como el comportamiento de las personas obedeciendo a costumbres, hábitos y valores previamente aceptados.'];
            this.palabras[1] = ['moral', 'Se concibe como el comportamiento de las personas obedeciendo a costumbres, hábitos y valores previamente aceptados.'];
            this.palabras[2] = ['moral', 'Se concibe como el comportamiento de las personas obedeciendo a costumbres, hábitos y valores previamente aceptados.'];
            this.palabras[3] = ['moral', 'Se concibe como el comportamiento de las personas obedeciendo a costumbres, hábitos y valores previamente aceptados.'];
            this.palabras[4] = ['moral', 'Se concibe como el comportamiento de las personas obedeciendo a costumbres, hábitos y valores previamente aceptados.'];
            this.palabras[5] = ['moral', 'Se concibe como el comportamiento de las personas obedeciendo a costumbres, hábitos y valores previamente aceptados.'];
            this.palabras[6] = ['moral', 'Se concibe como el comportamiento de las personas obedeciendo a costumbres, hábitos y valores previamente aceptados.'];
            this.palabras[7] = ['moral', 'Se concibe como el comportamiento de las personas obedeciendo a costumbres, hábitos y valores previamente aceptados.'];
            this.palabras[8] = ['moral', 'Se concibe como el comportamiento de las personas obedeciendo a costumbres, hábitos y valores previamente aceptados.'];
    ...
    Ahorcado.prototype.dibujarPoste = function() {
        ...
        this.canvas_ahorcado.canvasArea.strokeStyle = "#A48E39";
    ...
    Ahorcado.prototype.jugar = function(datos, btn) {
        ...
        if (!flag) {
            ...
            if (!ahorcado.vivo) {
                ...
                $('.puntaje').text("0%");
                $('.btns_modal').html('<button style="font-size: 20px;color: white;font-weight: bold;margin-top: 15px;background:#A48E39;" id="add" class="btn calificacion-intentar" data-dismiss="modal" onclick="reiniciar()">Volver a intentar</button>');
            ...
            if (this.gano()) {
                ...
                $('.btns_modal').html('<button type="button" class="btn" data-dismiss="modal" style="font-size: 22px;color: white; background:#A48E39; font-weight: bold;margin-top: 15px;width: 20%;">cerrar</button>');
                $("#calificacionModal").modal("show");
            }
        }
    };
