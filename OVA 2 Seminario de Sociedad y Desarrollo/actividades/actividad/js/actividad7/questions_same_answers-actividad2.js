...
QuestionsSameAnswers.prototype.score =  function () {
    ...
    if (puntaje == 100) {
        ...
        $('.img_res').html('<img src="../../../assets/img/img_ova/bien.png" style="max-width: 86%; margin-top: 7%;margin-left: 0%;">');
        ...
        $('.puntaje').text(Math.round(puntaje)+"%");
        $('.btns_modal').html('<button style="font-size: 20px;color: #811111;font-weight: bold;margin-top: -15px;" id="add" class="btn calificacion-intentar" data-dismiss="modal" onclick="reload()">Volver a intentar</button>');
      }
...
var TEMPLATE = '<form id="{{ id }}" method="post" class="qwsa-form">\
    ...
    <div class="text-center">\
        <button class="btn" style="background: #771E18; color: white;" type="submit" ><b>Calificar</b></button>\
    </div>\
</form>'
