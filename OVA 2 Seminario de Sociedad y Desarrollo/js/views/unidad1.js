...
var pdf = `<div class="col-md-12">
                  <p class="p_white">
                                    <a href="assets/PDF/UNIDAD1/SOBRENECESIDADES.pdf" target="_blank"> <img class="menu_superior mr-3 w-40px" src="assets/img/img_template/pdf.png">SOBRE NECESIDADES<b class="text-cafe"><u>Ver</u></b></a>
                  </p>
                  <p class="p_white">
                        <a href="assets/PDF/UNIDAD1/SOBRENECESIDADES.pdf" target="_blank"> <img class="menu_superior mr-3 w-40px" src="assets/img/img_template/pdf.png">EL GÉNERO DEL CONSUMO EN LA SOCIEDAD DEL CONSUMO <b class="text-cafe"><u>Ver</u></b></a>
                  </p>
                  <p class="p_white">
                        <a href="assets/PDF/UNIDAD1/SOBRENECESIDADES.pdf" target="_blank"> <img class="menu_superior mr-3 w-40px" src="assets/img/img_template/pdf.png">Una teoría de las necesidades humanas para el desarrollo <b class="text-cafe"><u>Ver</u></b></a>
                  </p>
                </div>`;
$('.pdfs').html(pdf);
$(function () {
