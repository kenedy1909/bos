...
function init_recurso_1() {
    ...
    var Ahorcado = function () {
        ...
        this.palabrasMake = function () {
            ...
            this.palabras[0] = ['palabra', 'Uno de los fundamentos que guio las esperanzas de la modernidad.'];
            this.palabras[1] = ['palabra', 'Uno de los fundamentos que guio las esperanzas de la modernidad.'];
            this.palabras[2] = ['palabra', 'Uno de los fundamentos que guio las esperanzas de la modernidad.'];
            this.palabras[3] = ['palabra', 'Uno de los fundamentos que guio las esperanzas de la modernidad.'];
            this.palabras[4] = ['palabra', 'Uno de los fundamentos que guio las esperanzas de la modernidad.'];
            this.palabras[5] = ['palabra', 'Uno de los fundamentos que guio las esperanzas de la modernidad.'];
            this.palabras[6] = ['palabra', 'Uno de los fundamentos que guio las esperanzas de la modernidad.'];
            this.palabras[7] = ['palabra', 'Uno de los fundamentos que guio las esperanzas de la modernidad.'];
            this.palabras[8] = ['palabra', 'Uno de los fundamentos que guio las esperanzas de la modernidad.'];
